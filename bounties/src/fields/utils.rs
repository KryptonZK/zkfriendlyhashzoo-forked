...
mod utils_test_48 {
    ...
    fn from_u64() {
        ...
        assert_eq!(to_hex(&ten), "000000000000000a")
    }
    ...
    fn div_mod_multiply_add() {
        ...
        assert_eq!(m, 1);
        assert_eq!(to_hex(&Scalar::from_repr(res).unwrap()), "0000000000000003");
...
mod utils_test_64 {
    ...
    fn from_u64() {
        let ten = super::from_u64::<Scalar>(10);
        assert_eq!(to_hex(&ten), "0000000000000000000000000000000a")
    }
