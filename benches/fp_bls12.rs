...
fn into_limbs(c: &mut Criterion) {
    ...
    c.bench_function("BLS12 into limbs", move |bench| {
        bench.iter(|| {
...
fn from_limbs(c: &mut Criterion) {
    ...
    c.bench_function("BLS12 from limbs", move |bench| {
        bench.iter(|| {
...
fn mult_by_word(c: &mut Criterion) {
    ...
    c.bench_function("BLS12 multiplication by word", move |bench| {
        bench.iter(|| {
...
fn div_by_u16(c: &mut Criterion) {
    ...
    c.bench_function("BLS12 division by u16", move |bench| {
        bench.iter(|| {
...
fn div_by_u16_recip(c: &mut Criterion) {
    ...
    c.bench_function(
        "BLS12 division by u16 using precomputed reciprocal",
        move |bench| {
            bench.iter(|| {
...
fn div_crandall(c: &mut Criterion) {
    ...
    c.bench_function("BLS12 division by 2^N-1 using crandall", move |bench| {
        bench.iter(|| {
...
fn add_by_word(c: &mut Criterion) {
    ...
    c.bench_function("BLS12 addition by word", move |bench| {
        bench.iter(|| {
...
fn partial_add(c: &mut Criterion) {
    ...
    c.bench_function("BLS12 partial addition", move |bench| {
        bench.iter(|| {
...
fn full_shr(c: &mut Criterion) {
    ...
    c.bench_function("BLS12 full shift right", move |bench| {
        bench.iter(|| {
...
fn full_shl(c: &mut Criterion) {
    ...
    c.bench_function("BLS12 full shift left", move |bench| {
        bench.iter(|| {
...
fn partial_shl(c: &mut Criterion) {
    ...
    c.bench_function("BLS12 partial shift left", move |bench| {
        bench.iter(|| {
...
fn criterion_benchmark_fields_bls12(c: &mut Criterion) {
    mult_by_word(c);
    div_by_u16(c);
    div_by_u16_recip(c);
    div_crandall(c);
...
criterion_group!(
    ...
    targets = criterion_benchmark_fields_bls12
);
