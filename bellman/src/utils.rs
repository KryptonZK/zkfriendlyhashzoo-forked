...
use bellman_ce::pairing::ff::{PrimeField, PrimeFieldDecodingError, PrimeFieldRepr};
...
pub fn field_element_from_shake<F: PrimeField>(reader: &mut Sha3XofReader) -> F {
    ...
    loop {
        ...
        for i in 0..words {
            ...
            for j in i * 8..min((i + 1) * 8, buf.len()) {
...
pub fn field_element_from_shake_without_0<F: PrimeField>(reader: &mut Sha3XofReader) -> F {
    loop {
